...
const DoctorQueue = () => {
  ...
  return (
    <div>
      <Panel className="mb-3 text-center text-white max-h-10 py-1 text-xl">Fila de Pacientes</Panel>
      <Panel>
        <DoctorQueueTable attendances={urgencies} />
        <DoctorQueueTable attendances={priorities} />
        <DoctorQueueTable attendances={standards} />
      </Panel>
    </div>
  );
};
