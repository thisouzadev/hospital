...
import NurseQueueTable from './NurseQueueTable';
...
const NurseQueue = () => {
  ...
  return (
    <div>
      ...
      <Panel>
        <NurseQueueTable attendances={urgencies} />
        <NurseQueueTable attendances={priorities} />
        <NurseQueueTable attendances={standards} />
      </Panel>
    </div>
  );
};
